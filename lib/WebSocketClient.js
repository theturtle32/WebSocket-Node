...
function WebSocketClient(config) {
    ...
    this.config = {
        ...
        tlsOptions: (config && config.tlsOptions) || {}
    };
...
WebSocketClient.prototype.connect = function(requestUrl, protocols, origin, headers, requestOptions) {
    var self = this;
    ...
    var req = (this.secure ? https : http).request(requestOptions);
