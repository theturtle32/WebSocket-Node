...
WebSocketRequest.prototype.readHandshake = function() {
    ...
    this.originHeader = 'sec-websocket-origin';
    ...
    else if (this.websocketVersion == '13') {
    ...
    this.origin = request.headers[this.originHeader];
...
WebSocketRequest.prototype.accept = function(acceptedProtocol, allowedOrigin) {
    ...
    if (acceptedProtocol) {
        ...
        response += this.originHeader + ": " + acceptedProtocol + "\r\n";
    }
    if (allowedOrigin) {
        allowedOrigin = allowedOrigin.replace(headerSanitizeRegExp, '');
        response += this.originHeader + ": " + allowedOrigin + "\r\n";
    }
