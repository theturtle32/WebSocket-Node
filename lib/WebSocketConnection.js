        ...
        case 0x02: // WebSocketFrame.BINARY_FRAME
            ...
            if (this.assembleFragments) {
                if (frame.fin) {
                    ...
                    // Fix for slow device message queue exceeding keepalivetime timeout
                    // and therefore resulting in connection being dropped because
                    // ping is stuck at back of queue an so no pong arrives in time.
