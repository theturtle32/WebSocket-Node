...
WebSocketConnection.prototype.sendCloseFrame = function(reasonCode, reasonText, cb) {
    if (typeof(reasonCode) !== 'number') {
        reasonCode = WebSocketConnection.CLOSE_REASON_NORMAL;
    }
    
    this._debug('sendCloseFrame state: %s, reasonCode: %d, reasonText: %s', this.state, reasonCode, reasonText);
