...
function WebSocketConnection(socket, extensions, protocol) {
    ...
    this.bufferList.on('write', this.handleBufferListWrite.bind(this));
};
...
extend(WebSocketConnection.prototype, {
    ...
    // Invoke frame parser when new data is added to the bufferlist
    handleBufferListWrite: function() {
